#!/usr/bin/env python3
"""
Script de scraping des paroles de Jacques Brel depuis paroles.net
Usage: uv run python scripts/scrape_lyrics.py
"""
...
DELAY_SECONDS = 2
HEADERS = {
    "User-Agent": "ParodleBot/1.0 (Educational lyrics game project)"
}
...
def get_song_list() -> list[dict[str, str]]:
    ...
    for page_path in ARTIST_PAGES:
        ...
        for link in soup.find_all('a', href=True):
            href = link['href']
            if '/jacques-brel/paroles-' in href and href not in seen_urls:
...
def main():
    print("=" * 50)
    print("Scraping des paroles de Jacques Brel")
    print("=" * 50)
